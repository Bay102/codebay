...
This document describes how the Community landing page decides which content to show, how trending is computed, and how "For you" content is selected. The logic referenced here lives primarily in `apps/community/src/app/page.tsx`, `apps/community/src/lib/landing.ts`, and `apps/community/src/lib/discussions.ts`.
...
- `PreferredTopicsDialog` and tag helpers:
  ...
  - `getPreferredTagIdsAction` (`apps/community/src/app/actions.ts`)
