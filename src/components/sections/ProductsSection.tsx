...
Our reports give investors confidence in your technical foundation and help you address gaps before they become deal-breakers.`,
  ...
  },
  {
    ...
    category: "Service",
    description:
      "CI/CD pipelines, cloud deployment, and infrastructure as code. Ship with confidence.",
    status: "Available",
    detailText: `From zero to production in days. We set up reliable CI/CD pipelines, container orchestration, and cloud infrastructure that scales with your growth.

Whether you need AWS, GCP, or a hybrid setup, we deliver infrastructure-as-code that your team can maintain and extend.`,
    detailImage:
      "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&q=80",
    detailImageAlt: "Cloud infrastructure and DevOps",
  },
];
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {showCloseButton && onClose && (
        <button
          onClick={onClose}
          className="icon-btn w-10 h-10 rounded-full flex items-center justify-center shrink-0 mt-4 self-start"
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-6 md:items-stretch">
          ...
          {!isMobile && selectedProduct && (
            <div className="liquid-glass-nav w-full md:w-[360px] lg:w-[400px] shrink-0 rounded-2xl p-6 animate-in slide-in-from-right-2 fade-in duration-300 border border-border/80">
