...
export function CommunityListingsHero({
  ...
  return (
    <SurfaceCard
      as="section"
      variant="borderless"
      className="relative isolate mb-6 overflow-hidden rounded-tl-3xl border border-border/40 bg-card/70 p-5 shadow-xl sm:mb-8 sm:p-6 lg:p-8"
    >
      <div
        className="pointer-events-none absolute inset-0 rounded-[inherit] bg-gradient-to-br from-primary/[0.08] via-transparent to-transparent"
        aria-hidden
      />
      <div
      ...
      <div className="relative z-10 grid gap-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(200px,0.42fr)] lg:items-start">
        <div className="min-w-0">
          ...
          <p className="font-hero mt-3 max-w-2xl text-sm leading-7 text-muted-foreground sm:text-base sm:leading-8">
            {description}
          </p>
